...
import project1 from "@/assets/projekti1.jpeg";
import project2 from "@/assets/hero2.jpeg";
import project3 from "@/assets/projekti3.jpeg";
      ...
      <section className="relative h-[90vh] min-h-[600px] flex items-center overflow-hidden pt-6 sm:pt-0">
        ...
        <div className="relative container mx-auto px-4">
          <div className="max-w-2xl pt-16 sm:pt-16 md:pt-0">
            ...
            <h1
              className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold text-primary-foreground mb-6 opacity-0 animate-slide-in-left"
              style={{ animationDelay: "0.12s" }}
            >
              {t(translations.hero.title)}
            </h1>
            <p
              className="text-lg md:text-xl text-primary-foreground/80 mb-8 opacity-0 animate-slide-in-left"
              style={{ animationDelay: "0.28s" }}
            >
              {t(translations.hero.subtitle)}
            </p>
            <div
              className="flex flex-wrap gap-4 opacity-0 animate-slide-in-left"
              style={{ animationDelay: "0.42s" }}
            >
              <Link
                to="/contact"
                className="inline-flex items-center gap-2 bg-primary text-primary-foreground px-6 py-3 rounded-xl font-medium hover:opacity-90 transition-all hover-scale"
              >
            ...
            <div
              className="mt-10 grid max-w-xl grid-cols-1 gap-4 sm:grid-cols-3 opacity-0 animate-fade-in"
            ...
            >
              ...
              <div
                className="rounded-2xl border border-primary-foreground/15 bg-primary-foreground/10 px-4 py-4 text-primary-foreground backdrop-blur-md hero-stat-card"
          ...
          <div className="pointer-events-none absolute right-4 top-1/2 hidden w-[280px] -translate-y-1/2 xl:block">
            <div className="floating-panel rounded-3xl border border-white/15 bg-white/10 p-5 text-primary-foreground backdrop-blur-xl">
              ...
              <p className="text-sm text-primary-foreground/75">
                Klare Ebenen, weiche Bewegungen und markante Einstiege machen
                den ersten Eindruck deutlich lebendiger.
              </p>
            </div>
          </div>
        </div>
            ...
            {services.map((s, i) => {
              ...
              return (
                ...
                >
                  <Link
                    to="/services"
                    className="group relative block overflow-hidden p-6 rounded-lg bg-card border border-border hover:border-primary/50 hover:shadow-lg transition-all hover-scale h-full service-glow-card"
                  >
                    ...
                    <Icon
                      size={32}
                      className="text-primary mb-4 transition-transform duration-500 group-hover:-translate-y-1 group-hover:scale-110"
                    />
                  ...
                  <div className="group overflow-hidden rounded-lg bg-card border border-border hover:shadow-xl transition-shadow project-lift-card">
                    <div className="overflow-hidden">
                      <img
                        ...
                        width={800}
                        height={600}
                        className="w-full h-56 object-cover group-hover:scale-110 group-hover:rotate-[1deg] transition-transform duration-700"
                      />
                    </div>
                    <div className="p-5">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 text-center">
          <ScrollReveal>
            ...
            <Link
              to="/contact"
              className="inline-flex items-center gap-2 bg-primary text-primary-foreground px-8 py-3 rounded-xl font-medium hover:opacity-90 transition-all hover-scale"
            >
