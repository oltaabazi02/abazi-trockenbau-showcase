      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {translations.projects.items.map((proj, i) => (
            <div key={i} className="group overflow-hidden rounded-lg bg-card border border-border">
              <div className="overflow-hidden">
                <img src={images[i]} alt={t(proj.title)} loading="lazy" width={800} height={600} className="w-full h-60 object-cover group-hover:scale-105 transition-transform duration-500" />
              </div>
              <div className="p-5">
