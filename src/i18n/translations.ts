...
export const translations = {
  ...
  home: {
    ...
    ctaTitle: {
      ...
      de: "Haben Sie ein Projekt im Sinn?",
    },
    ctaText: {
      al: "Na kontaktoni për një ofertë pa detyrim. Jemi të gatshëm t'ju ndihmojmë!",
      de: "Kontaktieren Sie uns für ein unverbindliches Angebot. Wir helfen Ihnen gerne!",
    },
    ctaButton: { al: "Na kontaktoni", de: "Kontaktieren Sie uns" },
  },
  services: {
    title: { al: "Shërbimet tona", de: "Unsere Leistungen" },
    subtitle: {
      al: "Ofrojmë shërbime profesionale në fushën e ndërtimit të brendshëm",
      de: "Wir bieten professionelle Dienstleistungen im Bereich Innenausbau",
    },
    trockenbau: {
      title: { al: "Trockenbau", de: "Trockenbau" },
      desc: {
        al: "Montim i mureve ndarëse, sistemet e mureve dhe tavaneve me gips-karton. Punë cilësore dhe e shpejtë.",
        de: "Montage von Trennwänden, Wand- und Deckensystemen aus Gipskarton. Qualitative und schnelle Arbeit.",
      },
    },
    innenausbau: {
      title: { al: "Innenausbau", de: "Innenausbau" },
      desc: {
        al: "Përfundimi i brendshëm komplet – nga dyshemeja deri te tavani. Dizajn modern dhe funksional.",
        de: "Kompletter Innenausbau – vom Boden bis zur Decke. Modernes und funktionales Design.",
      },
    },
    daemmung: {
      title: { al: "Dämmung", de: "Dämmung" },
      desc: {
        al: "Izolim termik dhe akustik profesional për mure, tavane dhe dysheme. Kurseni energji.",
        de: "Professionelle Wärme- und Schalldämmung für Wände, Decken und Böden. Energie sparen.",
      },
    },
    decken: {
      title: { al: "Deckenmontage", de: "Deckenmontage" },
      desc: {
        al: "Montim i tavaneve të varura, tavaneve akustike dhe sistemeve moderne të ndriçimit.",
        de: "Montage von Abhangdecken, Akustikdecken und modernen Beleuchtungssystemen.",
      },
    },
    renovierung: {
      title: { al: "Renovierung / Sanierung", de: "Renovierung / Sanierung" },
      desc: {
        al: "Rinovim komplet i hapësirave – banjo, kuzhinë, dhoma. Transformojmë hapësirën tuaj.",
        de: "Komplettrenovierung von Räumen – Bad, Küche, Zimmer. Wir verwandeln Ihren Raum.",
      },
    },
  },
  projects: {
  ...
  about: {
    title: { al: "Rreth nesh", de: "Über uns" },
    subtitle: {
      al: "Njihuni me kompaninë Abazi Trockenbau",
  ...
  contact: {
    title: { al: "Kontaktoni", de: "Kontakt" },
    subtitle: {
      al: "Na kontaktoni për një ofertë pa detyrim",
      de: "Kontaktieren Sie uns für ein unverbindliches Angebot",
    },
    name: { al: "Emri juaj", de: "Ihr Name" },
    email: { al: "Email", de: "E-Mail" },
